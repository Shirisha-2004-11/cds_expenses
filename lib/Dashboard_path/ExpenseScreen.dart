...
class ScannedReceipt {
  ...
  factory ScannedReceipt.fromJson(Map<String, dynamic> json) {
    ...
    // ── Prints the full raw JSON from Gemini ──
    debugPrint('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    debugPrint('📋 RAW JSON FROM GEMINI:');
    debugPrint(jsonEncode(json));
    debugPrint('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');

    // ── Prints each extracted field individually ──
...
class AddExpensePage extends StatefulWidget {
  // ✅ FIX 1: Added onExpenseAdded callback (was missing — caused the red error)
  final void Function(
    String category,
    String merchant,
    String date,
...
class _AddExpensePageState extends State<AddExpensePage>
  ...
  // 🔑 Gemini API Key
  static const String _apiKey = 'AIzaSyD7DGZv4PMTBtUDeoP_AZSMXX1rRMDVF_k';
  ...
  Future<void> _startScan() async {
    ...
    try {
      ...
      if (pickedFile == null) {
        debugPrint('⚠️  No image selected. Scan cancelled.');
      ...
      if (response.text != null) {
        // ── Print the full raw Gemini response ──
        debugPrint('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
        ...
        // ── Print what will be auto-filled into the form ──
        debugPrint('📝 AUTO-FILLING FORM WITH:');
        debugPrint('   Merchant field → "${data.merchant}"');
        debugPrint('   Date field     → "${data.date}"');
        debugPrint('   Amount field   → "${data.amount}"');
        debugPrint('   Category chip  → "${_formatCategory(data.category)}"');
        debugPrint('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
        ...
        debugPrint('❌ Gemini returned null response text.');
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 11.5,
                      color: const Color(0xFF7A5C00).withOpacity(0.7),
                      height: 1.4,
                    ),
                  ),
                ],
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: isSelected
                        ? const Color(0xFFE06B00).withOpacity(0.4)
    ...
    return FadeTransition(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFFE8F5F0),
          borderRadius: BorderRadius.circular(10),
          border: Border.all(color: const Color(0xFF2D6A5A).withOpacity(0.2)),
        ),
        child: Row(
          children: [
            Container(
            ...
            builder: (context, _) {
              return Positioned(
                ...
                child: Container(
                  height: 2,
                  decoration: BoxDecoration(
                    color: const Color(0xFF4FD1A5).withOpacity(0.8),
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF4FD1A5).withOpacity(0.4),
                        blurRadius: 6,
                        spreadRadius: 2,
                      ),
                    ],
    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          // ✅ FIX 2: calls onExpenseAdded before popping (was just Navigator.pop)
          onPressed: () {
            final amount =
