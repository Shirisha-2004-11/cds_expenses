...
=======
    'AIzaSyAot9z-zmnykDJ6p1DjpcwkUTIjoR_Z97I', // ← REPLACE with your own Gemini API keys
  ...
  Future<void> _saveExpense() async {
    ...
    try {
      ...
      expenseDate = DateFormat(
        'yyyy-MM-dd',
      ).format(DateTime(DateTime.now().year, parsed.month, parsed.day));
    } catch (_) {
    ...
    try {
      ...
      if (response.text != null) {
        ...
        setState(() {
          ...
          _autoFilled = true;
          _selectedCategory =
              overriddenCategory; // ← uses override, not raw AI output
          globalScanCount += 1;
        });
